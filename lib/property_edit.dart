...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PropertyEditWidget(),
    );
  }
}

class PropertyEditWidget extends StatefulWidget {
  @override
  _PropertyEditWidgetState createState() => _PropertyEditWidgetState();
  const PropertyEditWidget({
    Key? key,
    this.propertyType,
    this.area,
    this.ageOfProperty,
...
class _PropertyEditWidgetState extends State<PropertyEditWidget>
