...
class _TaskEditPageState extends State<TaskEditPage> {
  ...
  void initState() {
    super.initState();
    _taskNameController = widget.task != null
        ? TextEditingController(text: widget.task!.taskName)
        : TextEditingController();
    _taskTypes =
        widget.task != null ? widget.task!.taskTypes : _taskTypeOptions[0];
    _selectedContacts = widget.task != null ? widget.task!.taskWithWhom : [];
    _assignedTo = widget.task != null ? widget.task!.assignedTo : [];
    _startDate = widget.task != null ? widget.task!.startDate : null;
    _endDate = widget.task != null ? widget.task!.endDate : null;
    _priorityLevels =
        widget.task != null ? widget.task!.priorityLevels : _priorityOptions[0];
    _taskStatus =
        widget.task != null ? widget.task!.taskStatus : _statusOptions[0];
    _budgetAllocatedController = widget.task != null
        ? TextEditingController(text: widget.task!.budgetAllocated)
        : TextEditingController();
    _otherDependentTaskController =
        widget.task != null && widget.task!.otherDependentTask != null
            ? TextEditingController(text: widget.task!.otherDependentTask)
            : TextEditingController();
    _reminderDate = widget.task != null ? widget.task!.reminderDate : null;
    _repeats = widget.task != null ? widget.task!.repeats : _repeatOptions[0];
    _taskDescriptionController = widget.task != null
